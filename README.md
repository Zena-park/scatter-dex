...
1. **Product Introduction** — the problem → Pay & Pro → what's hidden and what's shown
   · Read in [English](https://0xinflux.medium.com/8c074a5bfeb6) · [한국어](https://0xinflux.medium.com/fc0bd3d6037a)
2. **Economics & Investors** — why build another, how it sustains itself without a token
   · Read in [English](https://0xinflux.medium.com/8682fb64978b) · [한국어](https://0xinflux.medium.com/5acd65c2df63)
3. **Developers** — under the hood: how ZK notes, half-proofs, and relayers fit together
   · Read in [English](https://0xinflux.medium.com/1959a62ae0ff) · [한국어](https://0xinflux.medium.com/56fba35dd63c)
4. **Protocol Internals** (deep-dive) — how commitments, nullifiers, circuits, and settlement fit together
   · Read in [English](https://0xinflux.medium.com/94466fcdc9be) · [한국어](https://0xinflux.medium.com/7fab0f806aa0)

**Companion — zk-X509 (Identity Gate):** Stop Building New Identity Systems: Bridging 4 Billion Existing IDs to Web3
· Read in [English](https://0xinflux.medium.com/68712efaa09e) · [한국어](https://0xinflux.medium.com/727143a942f1)
